...
\newcommand{\correoC}{mierdanay.1@estudiantec.cr}
% Datos del cuarto autor. Si no hay terecer autor, dejar las llaves vacías
\newcommand{\nombreC}{Jason}
\newcommand{\apellidoC}{Ulloa Picado}
\newcommand{\correoC}{prostiputa@estudiantec.cr}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{Captura de pantalla 2026-05-31 155039.png}
...
\hline
M7 & [Valor obtenido] & 0.5 \\
M8 & [Valor obtenido] & 0.5 \\
\hline
\end{tabular}
\end{table}
...
\hline
Ganancia de lazo abierto & 57.10 dB & [Valor simulado] \\
Frecuencia de corte & -- & [Valor simulado] \\
Ancho de banda & -- & [Valor simulado] \\
\hline
\end{tabular}
\end{table}
